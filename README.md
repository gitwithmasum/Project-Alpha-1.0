...
🔗 **Live site:** https://gitwithmasum.github.io/masum-billah-portfolio/

## Highlights

- Unified futuristic dark/neon design system
- Responsive Home, Resume, Projects, Research, and Contact pages
...
└── research/
    ├── README.md
    └── papers/
        ├── 01_Explainable_AI_Climate_Stress_Pilot_Study.pdf
        ├── 02_ML_Extreme_Rainfall_Early_Warning_Pilot_Study.pdf
        └── 03_Carbon_Aware_AI_Model_Selection_Pilot_Study.pdf
```
...
HTML5 · CSS3 · Bootstrap 5 · Bootstrap Icons · Vanilla JavaScript · GitHub Pages
